...
def main():
    ...
    # Tiles on the table
    table_tiles = [
        tile_id('red', 3), tile_id('blue', 3), tile_id('black', 3),
        tile_id('orange', 7), tile_id('orange', 8), tile_id('orange', 9)
    ]
    ti = build_ti(table_tiles)

    # Tiles on player's rack
    rack_tiles = [
        tile_id('orange', 6), tile_id('orange', 10),
        tile_id('red', 4), tile_id('blue', 4), tile_id('black', 4),
        tile_id('red', 5), tile_id('blue', 5), tile_id('black', 5),
        JOKER_ID
    ]
